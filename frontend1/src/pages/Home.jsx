        ...
        <div className="flex flex-col justify-start w-full">
          <div className="font-actor md:h-[1060px] h-[700px] md:px-7 relative w-full">
            <div className="md:h-[1060px] h-[700px] m-auto w-full">
              ...
              >
                <div className="flex flex-col items-start justify-start mb-[252px] mt-[199px] p-0.5 w-[47%] md:w-full">
                  <Text
            ...
            <Img
              className="absolute h-[550px] object-cover right-[3%] top-[25%] w-[44%]"
              src="images/sd.webp"
              alt="rectangleNine"
            />
          </div>

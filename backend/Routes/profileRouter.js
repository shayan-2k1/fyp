...
const {Addpicture,AddInterest, saveAboutMe,AddLanguage,getProfilePicture, getAllInterests,getAllLanguages,getAboutMe} = require('../Controllers/profileController');
...
router.get('/get-profilepicture', getProfilePicture);

  ...
  <div className="flex flex-row font-nunito gap-20 items-start justify-start w-auto sm:w-full">
    ...
    >
      Blogs
            ...
            <div className="mr-[150px] mt-[35px] flex w-[76%] gap-[65px] self-end md:mr-0 md:w-full md:flex-col">
              <div key="list29Kone1" className="flex w-full flex-col items-start gap-[7px] rounded-[10px] bg-lime-200 p-[21px] sm:p-5">
                ...
                <div className="mb-[19px] flex flex-col items-start gap-[7px]">
                  <Text size="lg" as="p" className="!font-rubik !text-[19.8px] tracking-[0.45px] !text-gray-900">3 Applicant </Text>
              ...
              <div key="list29Kone2" className="flex w-full flex-col items-start gap-[7px] rounded-[10px] bg-pink-200 p-[21px] sm:p-5">
                <Img src="images/img_coco_duotone_arrow.svg" alt="29k_one" className="h-[21px] w-[21px]" />
                <div className="mb-[19px] flex flex-col items-start gap-[7px]">
                  <Text size="lg" as="p" className="!font-rubik !text-[19.8px] tracking-[0.45px] !text-gray-900">0 Applicants</Text>
                ...
                <div className="flex flex-col gap-5 p-[5px]">
                  ...
                  <div className="flex w-full p-2">
                    ...
                    <div className="relative mb-2 h-[144px] w-full md:h-auto">
                      ...
                      {/* progress circle bar section */}
                      <CircularProgressbar strokeWidth={10} value={0} styles={{ "trail": { "stroke": "#f5f5f5" }, "path": { "strokeLinecap": "square" } }} className="absolute bottom-0 left-0 right-0 top-0 m-auto h-[144px] w-full" />
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  {applications.map((application, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell>
                        ...
                        {/* <Link
                          to={{
                            pathname: `/application`, // Add leading slash here
                            state: {
                              applicationId: application._id
                            }
                          }}
         ...
         {/* < div className="absolute bottom-[-405.00px] left-[0.00px] m-auto flex w-[20%] flex-col items-start bg-teal-50 shadow-xs" >
          ...
          < Img src="images/img_megaphone.svg" alt="megaphone_one" className="mt-[38px] h-[45px] w-[44px] self-end" />
           ...
           < div className="relative mb-[573px] mt-[651px] h-[209px] w-[77%] self-center" >
            ...
            < div className="absolute left-0 right-0 top-[0.00px] m-auto h-[202px] w-[96%] md:h-auto" >
             ...
             < div className="h-[202px] w-[62%] rounded-[32px] bg-gradient shadow-md" />
              ...
              < div className="absolute bottom-0 left-0 right-0 top-0 m-auto h-max w-full rounded-[32px] bg-gradient" >
                ...
                < div className="h-[202px] bg-[url(/public/images/img_group_20.png)] bg-cover bg-no-repeat p-5 md:h-auto" >
                  ...
                  < Img src="images/img_arrow_left.svg" alt="arrowleft_one" className="ml-[5px] mt-3.5 h-[11px] md:ml-0" />
                  </div >
                </div >
              </div >
            </div >
